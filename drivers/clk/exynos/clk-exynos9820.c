...
static const struct samsung_div_clock cmu_div_clks[] = {
...
static const struct samsung_mux_clock cmu_peric0_peri_mux_clks[] = {
	MUX(CLK_MOUT_CMU_PERIC0_PERI,
	    "mout_cmu_peric0_peri", mout_cmu_peric0_peri_p,
	    CLK_CON_MUX_CMU_PERIC0_PERI, 0, 1),
};

static const struct samsung_gate_clock cmu_peric0_peri_gate_clks[] = {
...
static const struct samsung_clk_group cmu_cmu_clks[] = {
	...
	{ S_CLK_DIV, cmu_div_clks, ARRAY_SIZE(cmu_div_clks) },
	{ S_CLK_MUX, cmu_peric0_peri_mux_clks, ARRAY_SIZE(cmu_peric0_peri_mux_clks) },
	{ S_CLK_GATE, cmu_peric0_peri_gate_clks, ARRAY_SIZE(cmu_peric0_peri_gate_clks) },
